...
export default function AnalyticsView() {
  ...
  if (loading) {
    return (
      <div className="max-w-7xl mx-auto py-16 flex flex-col items-center justify-center space-y-3 text-stone-500">
        ...
        <p className="text-xs font-bold">Loading Compact Data Fusion Telemetry Analytics...</p>
      </div>
    );
  }
  ...
  return (
    <div className="max-w-7xl mx-auto space-y-5 animate-fade-in pb-16">
      ...
      {/* Top Header */}
      <div className="bg-white border border-stone-200 rounded-3xl p-5 flex flex-wrap items-center justify-between gap-3 shadow-sm">
        <div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3 text-xs">
        <div className="bg-white border border-stone-200 rounded-2xl p-4 space-y-1 shadow-sm">
          ...
          <p className="text-2xl font-black text-stone-900">{analyticsData?.total_complaints || 850}</p>
        ...
        <div className="bg-white border border-stone-200 rounded-2xl p-4 space-y-1 shadow-sm">
          ...
          <p className="text-2xl font-black text-amber-600">{statusStats.pending || 99}</p>
        ...
        <div className="bg-white border border-stone-200 rounded-2xl p-4 space-y-1 shadow-sm">
          ...
          <p className="text-2xl font-black text-blue-600">{statusStats.approved || 1}</p>
        ...
        <div className="bg-white border border-stone-200 rounded-2xl p-4 space-y-1 shadow-sm">
          ...
          <p className="text-2xl font-black text-emerald-600">{statusStats.resolved || 0}</p>
      ...
      <div className="space-y-5">
        ...
        <div className="bg-white border border-stone-200 rounded-3xl p-5 space-y-3 shadow-sm">
          <div className="flex items-center justify-between pb-2 border-b border-stone-100">
            <h3 className="text-sm font-extrabold text-stone-900 flex items-center gap-2">
              <TrendingUp className="w-4 h-4 text-emerald-600" /> 2. Monsoon Request Surge Trend 2026
            </h3>
        ...
        <div className="bg-white border border-stone-200 rounded-3xl p-5 space-y-3 shadow-sm">
          ...
          <div className="h-52 w-full flex flex-col sm:flex-row items-center justify-center gap-6 pt-1">
            <div className="w-full sm:w-1/2 h-full">
              <ResponsiveContainer width="100%" height="100%">
                <PieChart>
                  <Pie data={languageData} cx="50%" cy="50%" innerRadius={45} outerRadius={75} paddingAngle={4} dataKey="value">
        ...
        <div className="bg-white border border-stone-200 rounded-3xl p-5 space-y-3 shadow-sm">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 text-xs font-bold">
            ...
            <div className="p-3.5 bg-orange-50/70 rounded-2xl border border-orange-200 space-y-1.5">
              ...
              <div className="text-[10px] text-stone-600 space-y-0.5 pt-1 border-t border-orange-200">
                ...
                <p>Avg PPI Score: <span className="text-stone-900 font-bold">84.2 / 100</span></p>
              </div>
            </div>
          </div>
        </div>
